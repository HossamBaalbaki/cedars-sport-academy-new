...
export const locations: Location[] = [
  {
    id: "1",
    name: "Cedars Academy — Jounieh Main Campus",
    nameAr: "أكاديمية سيدرز — الحرم الرئيسي جونية",
    address: "Rue de la Mer, Jounieh, Mount Lebanon",
    addressAr: "شارع البحر، جونية، جبل لبنان",
    city: "Jounieh",
    cityAr: "جونية",
  ...
  },
  {
    ...
    nameAr: "أكاديمية سيدرز — فرع بيروت",
    address: "Hamra Street, Ras Beirut, Beirut",
    addressAr: "شارع الحمراء، رأس بيروت، بيروت",
    city: "Beirut",
    cityAr: "بيروت",
  ...
  {
    id: "3",
    name: "Cedars Academy — Zahle Branch",
    nameAr: "أكاديمية سيدرز — فرع زحلة",
    address: "Rue du Stade, Zahle, Bekaa Valley",
    addressAr: "شارع الملعب، زحلة، البقاع",
    city: "Zahle",
    cityAr: "زحلة",
